...
class FakePantryRepository:
    ...
    def list_items(self, user_id: int, page: int, page_size: int, category: str | None, q: str | None, sort: str | None):
        """查詢食材列表。"""
...
def test_list_only_own_items(pantry_service: tuple[PantryService, FakePantryRepository]) -> None:
    ...
    result = service.list_items(user_id=1, page=1, page_size=20, category=None, q=None, sort=None)
...
def test_pagination(pantry_service: tuple[PantryService, FakePantryRepository]) -> None:
    ...
    result = service.list_items(user_id=1, page=2, page_size=2, category=None, q=None, sort=None)
...
def test_category_filter(pantry_service: tuple[PantryService, FakePantryRepository]) -> None:
    ...
    result = service.list_items(user_id=1, page=1, page_size=20, category="蔬菜", q=None, sort=None)
    assert result.total == 1
...
def test_q_search(pantry_service: tuple[PantryService, FakePantryRepository]) -> None:
    ...
    result = service.list_items(user_id=1, page=1, page_size=20, category=None, q="高麗", sort=None)
    assert result.total == 1
